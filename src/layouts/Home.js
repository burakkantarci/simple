  ...
  return (
    <div className="container">
      ...
      <div className="mt-36 border-bottom-dash pb-24 ">
        ...
        <a className="is-inline mt-8" target="_blank" rel="noopener noreferrer" href="https://youtu.be/ZeNf_gSU0KA">Product Innovation Series - From Designer to Product Manager</a>
      ...
      <div className="mt-36 border-bottom-dash pb-24">
        <h2>Past Projects</h2>
        <p>I have 7+ years of experience in shipping digital products. <Link to="/projects">See the list of the things I've ever made and contributed.</Link></p>
      </div>
      <div className="mt-36">
        <h2>Get in Touch</h2>
